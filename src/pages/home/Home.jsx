  ...
  return (
    <>
      ...
      <section className="projects-container all-projects-container ">
        <div id="two" className="project-container top-project-container-2">
          <div className="card-container-right">
            <Card card={cards[1]} />
          </div>
        </div>
        <div id="three" className="project-container top-project-container-4">
        ...
        <div id="four" className="project-container top-project-container-1">
          <div className="card-container-right">
            <Card card={cards[0]} />
          </div>
        </div>
