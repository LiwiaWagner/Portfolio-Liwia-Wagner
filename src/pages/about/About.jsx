      ...
      <main className="about-main-container">
        <article className="article-main">
          ...
          <p className="article-main-p-1">
            ...
            technical background. Born and raised in the small town of Żyrardów
            in central Poland, I now live and work in Warsaw.
          </p>
          <p className="article-main-p-2">
            From a young age, I dreamed of studying and living abroad. At 25, I
            left everything I knew and moved to Denmark to attend business
            school. Along the way, I lived in the United States and South Africa
            before ultimately returning to Poland, as there's no place like
            home.
          </p>
        </article>
