...
export const cards = [
  {
    ...
    btn: { text: "GO TO PROJECT", color: "var(--btn-project-id1)" },
    images: {
      desktop: {
        src: desktopImgCard1,
  ...
  },
  {
    ...
    btn: { text: "GO TO PROJECT", color: "var(--btn-project-id2)" },
    images: {
      desktop: {
        src: desktopImgCard2,
        alt: "Sample pictures of data visualization project.",
  ...
  },
  {
    ...
    btn: { text: "GO TO OBSERVABLE NOTEBOOK", color: "var(--btn-project-id3)" },
    images: {
      desktop: {
        src: desktopImgCard3,
        alt: "Sample pictures of data visualization project.",
  ...
  },
  {
    id: 4,
    order: 2,
    title: `Google BI Certificate: Cyclistic Capstone Project`,
    ...
    btn: { text: "GO TO PROJECT", color: "var(--btn-project-id4)" },
    images: {
      desktop: {
        src: desktopImgCard4,
        alt: "Sample pictures of data visualization project.",
