export const projectIntros = [
  {
    ...
    areasOfExpertise: {
      ...
      content:
        "Data Viz Design + Product Design + UX/UI Design + Data Experience (DX) Research",
    },
    ...
    introType: [
      {
        title: "THE PRODUCT",
        paragraph:
          "The project delivered an automated Tableau dashboard for real-time tracking of carbon emissions from business travel. It offered insights into emission trends, identifying key contributors and areas for improvement. I created a PostgreSQL database to structure data and developed a scalable data model that ensured accurate, efficient processing and seamless integration of new data. This system supports year-over-year tracking, empowering the company to make data-driven sustainability decisions.",
      },
      {
        title: "THE PROBLEM",
        paragraph:
          "The previous version of the product was an Excel-based report, which required a significant amount of manual work to prepare and clean the data before generating the carbon emissions report. Each month, new datasets had to be added manually, which made the entire process time-consuming and prone to human error. There was also a need to manually refresh the data to ensure the report reflected the most up-to-date information. This not only slowed down the reporting process but also introduced the risk of inconsistencies or outdated data being used for decision-making.",
      },
      {
        title: "",
        paragraph:
          "Furthermore, the report itself was quite basic in terms of data visualization. It contained only two tables, which offered a limited view of the data and lacked the depth required to identify key patterns or trends. As a result, users were unable to extract the insights they needed to make informed, strategic decisions for reducing carbon emissions. The lack of advanced visualizations and actionable insights made it difficult for the business to effectively track progress, identify areas for improvement, and develop targeted strategies for achieving sustainability goals.",
      },
      {
        title: "THE GOAL",
        paragraph:
          "The goal was to deliver advanced visualizations and actionable insights to help the business track progress, identify areas for improvement, and develop strategies to meet sustainability goals. By enhancing data presentation, the solution provided a dynamic view of the company’s carbon emissions, enabling decision-makers to monitor trends, track performance, and make informed choices to reduce the environmental impact of business travel. Ultimately, the objective was to improve efficiency while supporting the company’s broader sustainability efforts through data-driven insights.",
      },
    ],
    areasOfExpertise: {
      title: "AREAS OF EXPERTISE",
